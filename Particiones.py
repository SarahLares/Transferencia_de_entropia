...
#file1=open('datos1.txt','w') #Archivo para el acople 1 
file2=open('datos2.txt','w') #Archivo para el acople 2
...
for l in range(2,M):
    ...
    TranfEnt_XY=str(A[0])
    TranfEnt_YX=str(A[1])
    file1.write('     '+K+'      '+TranfEnt_XY+'     '+TranfEnt_YX+'\n')
    """
    #acople 2
    B=Inf(S,T,k)
    TranfEnt_ST=str(B[0])
    TranfEnt_TS=str(B[1])
    file2.write('     '+K+'      '+TranfEnt_ST+'     '+TranfEnt_TS+'\n')
#file1.close()
file2.close()
